module.exports = {
    ...
    rules: {
        ...
        // HTML 标签相关规则
        'vue/html-indent': ['error', 2], // 缩进 2 空格
        ...
        'vue/html-self-closing': ['error', {
            html: {
                void: 'always', // 自闭合标签（如 <img />）
                normal: 'never' // 非自闭合标签（如 <div></div>）
            }
        }],
        // 禁止重复属性
        ...
        'no-restricted-syntax': [
            ...
            },
            {
                ...
                message: 'Use Math.floor, Math.round, or Math.ceil instead \
                of parseInt to remove decimal points.' // 不建议使用 parseInt 来移除小数点
            }
        ],
